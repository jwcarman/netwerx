...
// -------------------------- OTHER METHODS --------------------------
     ...
     */
    default MultiClassifier<M> train(M features, int[] classes) {
        return train(features, classes, TrainingObservers.noop());
    }
     ...
     * @return a trained MultiClassifier instance that can predict classes for new samples.
     */
    MultiClassifier<M> train(M features, int[] classes, TrainingObserver observer);
